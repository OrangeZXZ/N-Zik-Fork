...
<h1>⏳ Only <a href="https://keepandroidopen.org"><img src="https://img.shields.io/badge/J--146-red?style=flat-round&logo=android&logoColor=white" alt="Android Lockdown"/></a> days remaining until Android Lockdown</h1>
...
- 📤 **Media Export** – Export cached or downloaded music to external storage with full metadata (title, artist, album, cover art, copyright, etc.) powered by FFmpeg. *(Note: Not available on 32-bit builds as they drop FFmpeg)*
