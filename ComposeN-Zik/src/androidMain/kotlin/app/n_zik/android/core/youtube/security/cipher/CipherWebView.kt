...
class CipherWebView private constructor(
    ...
    /**
     * Set when the renderer died (or an evaluate timed out, which on a wedged renderer is
     * indistinguishable). A dead instance must be discarded and recreated — per Android docs
     * a WebView whose render process is gone cannot be reused.
     */
    @Volatile
