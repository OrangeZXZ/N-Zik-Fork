    ...
    override suspend fun getChildren(
        ...
        return when (parentId) {
            PlayerServiceModern.PLAYLIST -> {
                ...
                val localCount = database.playlistTable.allAsPreview().first().filter { !it.playlist.isYoutubePlaylist && !it.playlist.name.startsWith(PINNED_PREFIX, true) && !it.playlist.name.startsWith(MONTHLY_PREFIX, true) }.size
